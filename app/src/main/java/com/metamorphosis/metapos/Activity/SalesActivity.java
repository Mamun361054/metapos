...
import com.metamorphosis.metapos.Fragment.FragmentCustom;
...
public class SalesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addFragment(FragmentToday.newInstance(), "Today");
        adapter.addFragment(FragmentSevenDays.newInstance(), "Last 7 days");
        adapter.addFragment(FragmentCustom.newInstance(), "Custom");
        ...
        ahBottomNavigation.setOnTabSelectedListener(new AHBottomNavigation.OnTabSelectedListener() {
            ...
            public boolean onTabSelected(int position, boolean wasSelected) {
                ...
                switch (position) {
                    ...
                    case 2:
                        Intent intent2 = new Intent(SalesActivity.this, AccountsActivity.class);
...
//                        finish();
                    ...
                    case 3:
                        Intent intent4 = new Intent(SalesActivity.this, MoreActivity.class);
